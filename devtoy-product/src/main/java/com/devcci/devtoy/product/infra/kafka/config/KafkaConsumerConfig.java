...
public class KafkaConsumerConfig {
    ...
    public KafkaConsumerConfig(@Value("${kafka.product.bootstrap-servers}") String kafkaBootstrapServers, TaskExecutorConfig taskExecutorConfig) {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "product-changed-group");
        return new DefaultKafkaConsumerFactory<>(props);
    }

    //    https://findmypiece.tistory.com/295
    @Bean
